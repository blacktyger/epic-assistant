...
export class SpendLedger {
  ...
  check() {
    ...
    const projected = this.usd + this.#reserved + spendConfig.reserveUsdPerRequest;
  ...
  reserve() {
    this.#reserved += spendConfig.reserveUsdPerRequest;
    return () => {
      this.#reserved = Math.max(0, this.#reserved - spendConfig.reserveUsdPerRequest);
    };
  }
